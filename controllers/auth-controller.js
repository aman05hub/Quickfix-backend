...
async function sendOtp(req, res){
    try{
        ...
        // Try sending email — if it fails, still return OTP in response
        // NOTE: Email sending may not work on all hosting platforms due to IP restrictions.
        // For demo/resume purposes, OTP is returned directly in the API response.
        let emailSent = false;
        try {
