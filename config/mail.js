...
// Email sending via Brevo HTTP API (port 443 - works on all hosting platforms)
            ...
            htmlContent: `
                <div style="font-family:Arial,sans-serif;background:#f4f4f4;padding:20px;">
                    <div style="max-width:500px;margin:auto;background:white;padding:30px;border-radius:12px;text-align:center;">
                        ...
                        <div style="font-size:36px;font-weight:bold;color:#4f46e5;letter-spacing:10px;margin:25px 0;">${otp}</div>
